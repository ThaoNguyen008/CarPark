      ...
      <ul class="navbar-nav">
        ...
        <li>
          ...
          <div class="collapse show" id="parkingLotManager">
            <ul class="navbar-nav ps-3">
              <li>
                <a href="ticket-list" class="nav-link px-3 choosing">
                  <span class="me-2"><i class="bi bi-list-ul"></i></span>
      ...
      <div class="col-md-12">
        <div class=" mb-12">
          <div class="card-header bg-body">
            <div class="col-md-12 fs-2">Ticket list</div>
          </div>
          <div class="card-body">
            <p class="card-text">
              <%--@elvariable id="ticketSearchModel" type="com.js.carpark.model.ticket.TicketSearchModel"--%>
              <form:form class="row gx-3 gy-2 align-items-center pb-3 justify-content-end"
                         method="post" modelAttribute="ticketSearchModel">
            <div class="col-sm-3">
              ...
              <div class="input-group">
                ...
                <form:input type="text" class="form-control" id="text" name="name"
                            placeholder="Ticket search" path="text"/>
              </div>
            </div>
            <div class="col-sm-4">
              ...
              <div class="input-group">
                ...
                <form:select class="form-select" id="filter" name="filter" path="type" onchange="typeChanging()">
                  <option value="1" ${ticketSearchModel.type == 1 ? "selected" : ""}>Trip</option>
                  <option value="2" ${ticketSearchModel.type == 2 ? "selected" : ""}>License plate</option>
                  <option value="3" ${ticketSearchModel.type == 3 ? "selected" : ""}>Customer</option>
                  <option value="4" ${ticketSearchModel.type == 4 ? "selected" : ""}>Booking time</option>
                </form:select>
              </div>
            </div>
            <div class="col-auto">
            ...
            <table id="pager" class="table table-bordered table-striped">
              ...
              <tbody>
              <c:forEach items="${tickets}" var="tik">
                <tr>
                  <th scope="row">${tik.id}</th>
                  <td>${tik.trip}</td>
                  <td>${tik.licensePlate}</td>
                  <td>${tik.customerName}</td>
                  <td>${tik.bookingTime}</td>
                  <td>
                    <a href="view-ticket-${tik.id}" class="text-decoration-none">
                        <span class="">
                          <i class="bi bi-eye-fill"></i>
                        </span>
                      <span> View </span>
                    </a>
                    <a href="delete-ticket-${tik.id}" class="text-decoration-none m-lg-2">
                        <span class="">
